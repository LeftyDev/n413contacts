        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <?php
				if($success){
					echo '
            			<p style="text-align:center;">Thanks for your contact info.  We will be back in touch if we feel like it.</p>';
				}else{
					echo '
						<p style="text-align:center;">Something went very wrong, and we lost your contact info.</p>';	
				}
			?>
